/*
    ...
    *********************
    Midimutant version
    *********************
    This is a modified version of the modified version by Johnty Wang,
    modified to pass through sysex.
    Created Spring 2017 by Dave Griffiths [dave@fo.am]
